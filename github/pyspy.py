...
def getPerms(path):
    ...
    user['read'] = 'r' if (mode & 0x0400) else '-'
    user['write'] = 'w' if (mode & 0x0200) else '-'
    user['execute'] = 'x' if (mode & 0x0100) else '-'
    group['read'] = 'r' if (mode & 0x0040) else '-'
    group['write'] = 'w' if (mode & 0x0020) else '-'
    group['execute'] = 'x' if (mode & 0x0010) else '-'
    other['read'] = 'r' if (mode & 0x0004) else '-'
    other['write'] = 'w' if (mode & 0x0002) else '-'
    other['execute'] = 'x' if (mode & 0x0001) else '-'
